...
public abstract class TagCharacter : EndpointBase, IEndpoint
{
    public static void Map(IEndpointRouteBuilder app) => app
        .MapPost("/{characterId:guid}/tag/{tagId:guid}", Handle)
        .WithSummary("Tags a given character.")
        .WithName(nameof(TagCharacter))
    ...
    {
        var command = new TagCharacterCommand(characterId, tagId);
